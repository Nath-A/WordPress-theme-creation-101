...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210613_tour_laptop_ae27f299b065ae056902_20210614223658_archive.zip';
	const ARCHIVE_SIZE		 = '40707209';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ae27f29-14223658';
    const SECONDARY_PACKAGE_HASH = 'f19976f-14223658';
	const VERSION			 = '1.4.1';
